# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 18:29:11 2019

@author: User
"""

import shapefile #Mengambil data dari shapefile
w=shapefile.Writer('soal3', shapeType=1) #Membuat file yang bernama soal3 dan mendefinisikan shapetype=1 untuk point
...
w.point(2,1.5) #membuat poin dengan menentukan titik x dan y
w.close() #penutup