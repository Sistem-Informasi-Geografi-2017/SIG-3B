...
w=shapefile.Writer('soal7', shapeType=shapefile.POLYGON) #Inisiasi Parameter untuk menulis file SHP. Parameter 1 menuliskan nama file yang akan di save, file yang ditulis yaitu "soal7". parameter 2 akan menginisiasi tipe bentuk yang akan dibangun. Tipe yang dibentuk yaitu polygon.
...
w.poly([[[1,3],[5,3],[1,2],[5,2]]]) #Setting shape pertama untuk mensetting tipe bentuk polygon
