...
w=shapefile.Writer("soal2",shapeType=1) #Inisiasi Parameter untuk menulis file SHP. Parameter 1 menuliskan nama file yang akan di save. File yang ditulis yaitu "soal2" dan parameter 2 menentukan tipe bentuk yang akan dibuat/dibangun. Bentuk yang dibangun adalah bentuk point.
